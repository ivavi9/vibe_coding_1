...
import { API_CONFIG, GOOGLE_CONFIG, FEATURE_FLAGS, GUEST_MODE_CONFIG } from '../../client/src/config/constants';
...
describe('🔍 REGRESSION TESTS - Core Features', () => {
  ...
  describe('📊 Progress Tracking', () => {
    it('should support progress management', () => {
      expect(API_CONFIG.ENDPOINTS.PROGRESS).toBe('/api/v1/progress');
    });
  });
  ...
  describe('✅ Validation Rules', () => {
    it('should have consistent validation constants', () => {
      const { VALIDATION } = await import('../../client/src/config/constants');
